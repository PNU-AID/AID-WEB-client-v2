    ...
    <>
      ...
      <section className="flex items-center justify-center w-full h-screen bg-white">
        <motion.div
          ...
          transition={{ type: 'spring', stiffness: 300 }}
        >
          <div className="flex flex-col items-center justify-center w-full h-full gap-4 m-auto text-sm text-center">
            ...
            <p>본 동아리는 부산대학교 AI 동아리 조준수 교수님의 지도 아래,</p>
            <p>
              부산대학교 정보컴퓨터공학 학생들을 중심으로 2022년 1학기에
